...
urlpatterns = [
    ...
    path("propostas/<int:pk>/editar/", views.proposta_editar, name="proposta_editar"),
    path("propostas/<int:pk>/acompanhamento/", views.proposta_acompanhamento, name="proposta_acompanhamento"),
    path("propostas/<int:pk>/excluir/", views.proposta_excluir, name="proposta_excluir"),
    ...
    path("linhas/<int:pk>/editar/", views.linha_editar, name="linha_editar"),
    path("linhas/<int:pk>/excluir/", views.linha_excluir, name="linha_excluir"),
